...
export default function Button({
  ...
  const variantStyles = {
    primary: 'bg-gradient-to-r from-primary to-primary-container text-white border border-primary/20 shadow-[0_0_20px_rgba(139,92,246,0.15)]',
    secondary: 'bg-secondary/40 border border-glass-stroke text-on-surface backdrop-blur-md',
    ghost: 'text-on-surface-variant',
    highlight: 'bg-gradient-to-r from-tertiary to-tertiary-container text-on-tertiary border border-tertiary/20 shadow-[0_0_20px_rgba(34,211,238,0.15)]'
  };
